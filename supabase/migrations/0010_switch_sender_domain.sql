-- Changement d'adresse d'envoi : robin.vergnes@lyftt.fr -> robin@vgs-autos.fr
-- (domaine que Robin controle reellement sur O2switch et va verifier dans
-- Resend). Seule la ligne v_from change, tout le reste de la logique
-- (calcul des stats, coaching, envoi async + reconciliation) est identique.
